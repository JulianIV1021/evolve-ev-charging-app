  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: _ChargingProgressIndicatorPainter(
        ...
        progress: progress,
        deliveredText: widget.deliveredText,
...
class _ChargingProgressIndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawProgressArc(canvas, center, radius + 2);
    if (spinning) {
      _drawRotatingRing(canvas, center, radius + 10);
      final paint = Paint()
        ..color = greyBlue
        ..strokeWidth = 8
  ...
  void _drawProgressArc(Canvas canvas, Offset center, double radius) {
    final capped = percentage.clamp(0.0, 1.0);
    final paint = Paint()
      ..color = greyBlue
      ..strokeWidth = 10
      ..style = PaintingStyle.stroke
